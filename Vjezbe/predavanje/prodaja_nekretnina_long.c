...
int main(void)
{
    ...
    for (int i = 0; i < n; i++)
    {
        for (int j = 0; j < duljina_cijene - (int)log10(nekretnine[i].cijena) - 1; j++)
        {
            printf(" ");
        }
        printf(" %d EUR", nekretnine[i].cijena);

        for (int j = 0; j < duljina_povrsine - (int)log10(nekretnine[i].povrsina) - 1; j++)
        {
            printf(" ");
        }
        printf("     %d m2", nekretnine[i].povrsina);

        for (int j = 0; j < duljina_sifre - (int)log10(nekretnine[i].sifra_oglasa) - 1; j++)
        {
            printf(" ");
        }
        printf("    %d\n", nekretnine[i].sifra_oglasa);
    }
